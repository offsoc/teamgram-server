...
type ConfigurationClient interface {
	...
	HelpGetAppConfig(ctx context.Context, in *mtproto.TLHelpGetAppConfig) (*mtproto.Help_AppConfig, error)
}
...
func (m *defaultConfigurationClient) HelpGetAppConfig(ctx context.Context, in *mtproto.TLHelpGetAppConfig) (*mtproto.Help_AppConfig, error) {
	client := mtproto.NewRPCConfigurationClient(m.cli.Conn())
